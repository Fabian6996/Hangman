...
string words[20] = { "freedom" ,"comfort","weather","explore","success","account","journey","support","problem","library","powerful","perfect","express","violent","network","fortune","service","captain","traffic","mission" };
